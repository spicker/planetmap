...
let earth = new Planet(6300, 150000000, Math.PI / 2, 0, { color: 0x0077ff });
let sun = new Planet(695700, 0, 0, 0, { color: 0xffffff, emissive: 0xffffaa });
let moon = new Planet(1737, 150385000, Math.PI / 2, 0);
let venus = new Planet(6051, 108280000, Math.PI / 2.0, { color: 0xffffee });
let mars = new Planet(3389, 227939200, Math.PI / 2, 0, { color: 0xff8822 });
let saturn = new Planet(58232, 1433530000, Math.PI / 2, 0);
let jupiter = new Planet(69911, 778570000, Math.PI / 2, 0);
