...
var earth = new Planet(100, new THREE.Vector3(0, 0, 0), null, null);
earth.draw(scene);
addTestSphere3();
addAmbientLight();

var earthOutline = showOutline(earth.mesh);
...
function updateOutline(obj, objOutline) {
    var distanceToCamera = obj.position.distanceTo(camera.position);
    var lineThickness = distanceToCamera / (obj.geometry.parameters.radius * 500);
...
function animate() {
    ...
    updateOutline(earth.mesh, earthOutline);
